...
class FastVisitReqState extends State<FastVisitReq>{
      ...
      appBar: new AppBar(
        ...
        body:new Padding(
          ...
          child: new Column(
            ...
            children: <Widget>[
              buildForm('拜访人姓名', '请输入真实姓名', true, 25,_visitNameControl,TextInputType.text),
              new Divider(
                color: Colors.black54,
              ),
              buildForm('拜访人手机号', '请输入拜访人手机号', true, 10,_visitPhoneControl,TextInputType.phone),
              new Divider(
                color: Colors.black54,
              ),
  ...
  Widget buildForm(
      String labelText, String hintText, bool autofocus, double left,TextEditingController controller,TextInputType inputtype) {
    return new Row(
      mainAxisAlignment: MainAxisAlignment.start,
      crossAxisAlignment: CrossAxisAlignment.center,
      children: <Widget>[
