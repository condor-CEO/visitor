              ...
              child: Stack(
                children: <Widget>[
                  Positioned(
                    child: FittedBox(
                      fit: BoxFit.fill,
                      child: Image.asset("asset/icons/大楼.png"),
                    ),
                    width: 40,
                    height: 40,
                  ),
                  Positioned(
                    child: Text('$noticeTitle',overflow: TextOverflow.ellipsis,maxLines: 1,style: TextStyle(fontSize: 16.0),),
                    left: 60,
                    width: 220,
                  ),
                  Positioned(
                    child: Text('${content}',overflow: TextOverflow.ellipsis,maxLines: 1,style: TextStyle(fontSize: 15.0,color: Colors.black45),),
                    left: 60,
                    width: 270,
                    top: 20,
                  ),
                  Positioned(
                    child: Container(
                      ...
                      child: Text('${createDate}',style: TextStyle(fontSize: 14.0,color: Colors.black45),),
                    ),
                    right: 0,
                  ),
                ],
...
class NoticeDetail extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: orgType=="company"?Text('公司公告',style: new TextStyle(
            fontSize: 17.0, color: Colors.white),):Text('大楼公告',style: new TextStyle(
            fontSize: 17.0, color: Colors.white),),
        centerTitle: true,
        backgroundColor: Theme.of(context).appBarTheme.color,
        leading: IconButton(icon: Icon(Icons.arrow_back_ios), onPressed: (){Navigator.pop(context);}),
      ...
      body: Container(
        ...
        child: Column(
          children: <Widget>[
            Container(
              child:  Text(noticeTitle,style: TextStyle(fontSize: 18.0),),
              padding: EdgeInsets.only(bottom: 10.0),
            ),
            Text('$createDate $createTime',style: TextStyle(color: Colors.black45),),
            Divider(),
            Text('$content'),
          ],
        ),
