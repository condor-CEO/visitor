              ...
              child: new Stack(
                children: <Widget>[
                  ...
                  Positioned(
                    ...
                    }, child: Text('确认',textAlign: TextAlign.center,style: TextStyle(fontSize: 16.0,color: Colors.blue),)),
                  ),
                  Positioned(
                    bottom: 8,
                    right: 8,
    ...
    return Column(
          children: <Widget>[
            Container(
              ...
              child:   Text('订单详情',style: TextStyle(color: Colors.black45),),
            ),
            Divider(height: 0,),
            ListTile(title: Text('名称'),trailing: Text(widget.roomInfo.roomName),),
            Divider(height: 0,),
            ListTile(title: Text('时间'),trailing: Text(widget.startTime.replaceAll("\.5", ":30").replaceAll("\.0", ":00")+"-"+widget.endTime.replaceAll("\.5", ":30").replaceAll("\.0", ":00")),),
            Divider(height: 0,),
            ListTile(title: Text('费用'),trailing: Text(amount),),
            Divider(height: 0,),
          ],
    );
  }
    ...
    return Column(
        children: <Widget>[
          Container(
            ...
            padding: EdgeInsets.only(top: 10.0,bottom: 10.0,left: 20.0),
            width: MediaQuery.of(context).size.width,
            child:   Text('选择支付方式',style: TextStyle(color: Colors.black45),),
          ),
          Divider(height: 0,),
          CheckboxListTile(
            secondary: Container(
              width: 50,
              child: Image.asset("asset/icons/支付宝logo.png"),
            ),
            title: Text('支付宝',style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold),),
